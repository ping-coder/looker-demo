# The name of this view in Looker is "Events 20220628"
view: events_20220628 {
  # The sql_table_name parameter indicates the underlying database table
  # to be used for all fields in this view.
  sql_table_name: `mocha.events_20220628`
    ;;
...
# The name of this view in Looker is "Events 20220628 Items"
view: events_20220628__items {
  ...
  dimension: events_20220628__items {
    type: string
    hidden: yes
    sql: events_20220628__items ;;
  }
...
# The name of this view in Looker is "Events 20220628 Event Params"
view: events_20220628__event_params {
  # No primary key is defined for this view. In order to join this view in an Explore,
  # define primary_key: yes on a dimension that has no repeated values.
  ...
  dimension: events_20220628__event_params {
    type: string
    hidden: yes
    sql: events_20220628__event_params ;;
  }
...
# The name of this view in Looker is "Events 20220628 User Properties"
view: events_20220628__user_properties {
  # No primary key is defined for this view. In order to join this view in an Explore,
  # define primary_key: yes on a dimension that has no repeated values.
  ...
  dimension: events_20220628__user_properties {
    type: string
    hidden: yes
    sql: events_20220628__user_properties ;;
  }

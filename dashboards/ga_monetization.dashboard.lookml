- dashboard: ga_monetization
  title: GA Monetization
  layout: newspaper
  elements:
  ...
  - title: ARPDAU - Ads
    ...
    explore: ga_events
    type: single_value
    fields: [ga_events.average_ad_revenue_per_user, ga_events.event_date]
    fill_fields: [ga_events.event_date]
    filters: {}
    limit: 500
    dynamic_fields: [{table_calculation: arpdau_ads, label: ARPDAU - Ads, expression: 'mean(${ga_events.average_ad_revenue_per_user})',
        value_format: !!null '', value_format_name: usd, _kind_hint: measure, _type_hint: number}]
    query_timezone: America/Los_Angeles
    hidden_fields: [ga_events.average_ad_revenue_per_user]
    note_state: collapsed
    note_display: hover
  ...
  - title: Revenue After UA
    ...
    explore: ga_events
    type: looker_column
    fields: [ga_events.event_date, ga_events.total_revenue, ga_events.total_install_spend]
    fill_fields: [ga_events.event_date]
    filters: {}
    sorts: [ga_events.event_date desc]
    limit: 500
    column_limit: 50
    dynamic_fields: [{table_calculation: ua, label: UA, expression: "${ga_events.total_install_spend}\
    ...
    y_axes: [{label: '', orientation: left, series: [{axisId: ga_events.total_revenue,
            id: ga_events.total_revenue, name: Total Revenue}], showLabels: true, showValues: true,
        unpinAxis: false, tickDensity: default, type: linear}, {label: !!null '',
        orientation: right, series: [{axisId: ga_events.average_revenue_per_spender,
    ...
    hidden_fields: [ga_events.total_install_spend]
    title_hidden: true
    listen:
      Date Range: ga_events.event_date
      Drill Down: ga_events.drill_by
  ...
  - title: Revenue after UA
    ...
    explore: ga_events
    type: single_value
    fields: [ga_events.total_revenue_after_UA]
    filters: {}
    limit: 500
    query_timezone: America/Los_Angeles
    note_state: collapsed
  ...
  - title: ARPDAU - IAP
    ...
    explore: ga_events
    type: single_value
    fields: [ga_events.average_iap_revenue_per_user, ga_events.event_date]
    fill_fields: [ga_events.event_date]
    filters: {}
    sorts: [ga_events.event_date desc]
    limit: 500
    dynamic_fields: [{table_calculation: arpdau_iap, label: ARPDAU - IAP, expression: 'mean(${ga_events.average_iap_revenue_per_user})',
        value_format: !!null '', value_format_name: usd, _kind_hint: measure, _type_hint: number}]
    query_timezone: America/Los_Angeles
    hidden_fields: [ga_events.average_iap_revenue_per_user]
    y_axes: []
    note_state: collapsed
    note_display: hover
  ...
  - title: IAP/Ad Revenue per Player
    ...
    explore: ga_events
    type: looker_column
    fields: [ga_events.event_date, ga_events.average_ad_revenue_per_user, ga_events.average_iap_revenue_per_user]
    fill_fields: [ga_events.event_date]
    filters: {}
    sorts: [ga_events.event_date desc]
    limit: 500
    ...
    y_axis_gridlines: false
    show_view_names: false
    y_axes: [{label: '', orientation: left, series: [{axisId: ga_events.average_ad_revenue_per_user,
            id: ga_events.average_ad_revenue_per_user, name: ARPU - Ads}, {axisId: ga_events.average_iap_revenue_per_user,
            id: ga_events.average_iap_revenue_per_user, name: ARPU - IAP}], showLabels: true,
        showValues: true, unpinAxis: false, tickDensity: default, type: linear}]
    show_y_axis_labels: true
    show_y_axis_ticks: true
    y_axis_tick_density: default
  ...
  - title: LTV (0-7 days) Per Country
    ...
    explore: ga_events
    type: looker_column
    fields: [ga_events.retention_day, ga_events.average_revenue_per_user, ga_events.cost_per_install,
      ga_events.country]
    pivots: [ga_events.country]
    filters:
      ga_events.retention_day: "<=7"
      # ga_events.is_top_10_country: 'Yes'
    sorts: [ga_events.country 0, ga_events.retention_day]
    limit: 500
    column_limit: 50
    dynamic_fields: [{table_calculation: ltv_total, label: LTV - Total, expression: 'running_total(${ga_events.average_revenue_per_user})',
        value_format: !!null '', value_format_name: usd, _kind_hint: measure, _type_hint: number},
      {table_calculation: less_than_cpi, label: Less than CPI, expression: 'if(${ltv_total}
        ...
        value_format: !!null '', value_format_name: usd, _kind_hint: measure, _type_hint: number},
      {table_calculation: cpi, label: CPI, expression: 'running_total(${ga_events.cost_per_install})',
        value_format: !!null '', value_format_name: usd, _kind_hint: measure, _type_hint: number}]
    color_application:
      collection_id: 611da387-0e33-4239-aef0-a187c149cf88
      palette_id: f31efe28-e698-428c-8420-fcb37f2010aa
    ...
    show_view_names: false
    y_axes: [{label: '', orientation: left, series: [{id: ga_events.total_revenue, name: Total
              Revenue, axisId: ga_events.total_revenue}], showLabels: true, showValues: true,
    ...
    show_null_points: true
    interpolation: linear
    hidden_fields: [ga_events.average_revenue_per_user, ltv_total, ga_events.cost_per_install,
      cpi]
    note_state: collapsed
    note_display: hover
  ...
  - title: IAP Purchase Sizes
    ...
    explore: ga_events
    type: looker_scatter
    fields: [ga_events.iap_purchase_tier, ga_events.total_iap_revenue, ga_events.number_of_iap_purchases]
    filters:
      ga_events.iap_purchase_tier: "-Below 0,-Undefined"
    sorts: [ga_events.iap_purchase_tier]
    limit: 500
    column_limit: 50
    total: true
    dynamic_fields: [{table_calculation: of_total, label: "% of total", expression: "${ga_events.total_iap_revenue}/\
          \ ${ga_events.total_iap_revenue:total}", value_format: !!null '', value_format_name: percent_2,
        _kind_hint: measure, _type_hint: number}]
    x_axis_gridlines: false
    y_axis_gridlines: true
    show_view_names: false
    y_axes: [{label: '', orientation: left, series: [{axisId: ga_events.total_iap_revenue,
            id: ga_events.total_iap_revenue, name: Total IAP Revenue}], showLabels: true,
    ...
    x_axis_reversed: false
    y_axis_reversed: false
    size_by_field: ga_events.number_of_iap_purchases
    plot_size_by_field: false
    trellis: ''
    stacking: ''
    limit_displayed_rows: false
  ...
  - title: Transactions per Spender
    ...
    explore: ga_events
    type: single_value
    fields: [ga_events.transactions_per_spender]
    filters: {}
    limit: 500
    column_limit: 50
    hidden_fields: []
  ...
  - title: Retaining Spenders
    ...
    explore: ga_events
    type: looker_column
    fields: [ga_events.retention_day, ga_events.percent_spenders, ga_events.total_iap_revenue]
    filters:
      ga_events.retention_day: "<=70"
    sorts: [ga_events.retention_day]
    limit: 500
    column_limit: 50
    dynamic_fields: [{table_calculation: total_iap_revenue, label: Total IAP Revenue,
        expression: 'running_total(${ga_events.total_iap_revenue})', value_format: !!null '',
        value_format_name: usd_0, _kind_hint: measure, _type_hint: number}]
    x_axis_gridlines: false
    y_axis_gridlines: true
    show_view_names: false
    y_axes: [{label: '', orientation: left, series: [{axisId: ga_events.percent_spenders,
            id: ga_events.percent_spenders, name: Percent Spenders}], showLabels: true,
        showValues: true, unpinAxis: false, tickDensity: default, tickDensityCustom: 5,
    ...
    show_silhouette: false
    totals_color: "#808080"
    hidden_fields: [ga_events.total_iap_revenue]
    note_state: expanded
    note_display: hover
  ...
  - title: Revenue per Ad Shown
    ...
    explore: ga_events
    type: looker_map
    fields: [ga_events.country, ga_events.number_of_ads_shown, ga_events.total_ad_revenue]
    filters:
      ga_events.number_of_ads_shown: ">1000"
    sorts: [revenue_per_ad_shown desc]
    limit: 500
    column_limit: 50
    dynamic_fields: [{table_calculation: revenue_per_ad_shown, label: Revenue per
          Ad Shown, expression: "${ga_events.total_ad_revenue}/${ga_events.number_of_ads_shown}",
    ...
    hidden_fields: [ga_events.total_ad_revenue, ga_events.number_of_ads_shown]
    note_state: expanded
    note_display: hover
  ...
  - title: Revenue per Ad
    ...
    explore: ga_events
    type: single_value
    fields: [ga_events.number_of_ads_shown, ga_events.total_ad_revenue]
    filters:
      ga_events.number_of_ads_shown: ">1000"
    limit: 500
    column_limit: 50
  ...
  - title: Ads Per Session
    ...
    explore: ga_events
    type: single_value
    fields: [ga_events.number_of_ads_shown, ga_events.number_of_sesssions]
    filters:
      ga_events.number_of_ads_shown: ">1000"
    limit: 500
    column_limit: 50
    dynamic_fields: [{table_calculation: ads_per_session, label: Ads per Session,
        expression: "${ga_events.number_of_ads_shown}/${ga_events.number_of_sesssions}",
    ...
    quantize_map_value_colors: false
    reverse_map_value_colors: true
    hidden_fields: [ga_events.number_of_ads_shown, ga_events.number_of_sesssions]
    series_types: {}
    note_state: expanded
    note_display: hover
  ...
  - title: Revenue by Network
    ...
    explore: ga_events
    type: table
    fields: [ga_events.number_of_ads_shown, ga_events.total_ad_revenue, ga_events.ad_network]
    filters:
      ga_events.number_of_ads_shown: ">1000"
    sorts: [revenue_per_ad_shown desc]
    limit: 500
    ...
    conditional_formatting: [{type: along a scale..., value: !!null '', background_color: "#3EB0D5",
        ...
        bold: false, italic: false, strikethrough: false, fields: [ga_events.number_of_ads_shown]}]

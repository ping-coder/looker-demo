...
view: funnel_explorer {
  ...
  derived_table: {
    sql: SELECT
      ...
      FROM ${ga_events.SQL_TABLE_NAME} AS events_sessionized
  ...
  parameter: event_1 {
    suggest_dimension: ga_events.event_name
    suggest_explore: ga_events
  }
  ...
  filter: game_name {
    type: string
    suggest_dimension: ga_events.game_name
    suggest_explore: ga_events
  }
